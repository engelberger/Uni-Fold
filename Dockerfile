...
RUN /usr/bin/python3.10 -m pip -q install git+https://github.com/sokrypton/ColabDesign.git@gamma py3dmol gdown libmsym
...
RUN wget ${UNICORE_URL} && \
    /usr/bin/python3.10 -m pip -q install "unicore-0.0.1+cu118torch2.0.0-cp310-cp310-linux_x86_64.whl" && \
